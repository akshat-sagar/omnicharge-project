      ...
      <div className="flex h-full flex-col">
        ...
        >
          <div className={['flex items-center gap-2', effectiveCollapsed ? 'justify-center w-full' : 'justify-start'].join(' ')}>
            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl bg-primary-600 shadow-[0_10px_25px_rgba(59,130,246,0.35)]">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        <header className="app-topbar flex h-16 flex-shrink-0 items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="rounded-xl p-2 text-surface-500 transition-colors hover:bg-white/70 hover:text-surface-700 lg:hidden"
          ...
          <div className="flex items-center gap-3">
            <span className="rounded-full border border-primary-200 bg-primary-50/80 px-2.5 py-0.5 text-xs font-medium text-primary-600 backdrop-blur">
              Admin
            </span>
          </div>
        </header>
