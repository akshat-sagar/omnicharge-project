...
import { paymentService } from '../../../core/services/rechargePaymentService';
import { StatCard, Card, StatusBadge, EmptyState } from '../../../shared/components/ui';
import { formatCurrency } from '../../../shared/utils/helpers';
import type { RechargeResponseDTO, TransactionResponseDTO } from '../../../shared/types';
    ...
    <motion.div variants={stagger} initial="initial" animate="animate">
      ...
      <motion.div
        ...
        className={[
          ...
          isDark
            ? 'border-[#1f2b43] bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.18),transparent_30%),radial-gradient(circle_at_top_right,rgba(34,201,137,0.08),transparent_22%),linear-gradient(135deg,rgba(13,17,31,0.94),rgba(10,16,28,0.9))]'
            : 'border-white/70 bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.16),transparent_28%),radial-gradient(circle_at_top_right,rgba(74,222,128,0.1),transparent_20%),linear-gradient(135deg,rgba(255,255,255,0.92),rgba(240,253,244,0.86))] shadow-[0_24px_60px_rgba(15,23,42,0.08)]',
        ].join(' ')}
      >
