...
import { Card, SectionHeader, Badge, ConfirmDialog } from '../../../shared/components/ui';
import Input from '../../../shared/components/ui/Input';
import Button from '../../../shared/components/ui/Button';
import ThemeToggle from '../../../shared/components/ui/ThemeToggle';
import { profileSchema, type ProfileFormData } from '../../../shared/utils/validationSchemas';
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          <Card
            className={[
              ...
              isDark
                ? 'bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.18),transparent_30%),linear-gradient(135deg,rgba(13,17,31,0.94),rgba(11,18,32,0.9))]'
                : 'bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.12),transparent_32%),linear-gradient(135deg,rgba(255,255,255,0.98),rgba(240,253,244,0.92))]',
            ].join(' ')}
          >
                ...
                <div
                  className={[
                    ...
                    isDark
                      ...
                      : 'bg-gradient-to-br from-primary-100 via-green-50 to-white ring-1 ring-primary-100',
                  ].join(' ')}
                >
