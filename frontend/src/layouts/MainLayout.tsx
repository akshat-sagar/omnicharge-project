      ...
      <div className="flex flex-col h-full">
        ...
        >
          <div className={['flex items-center gap-2', effectiveCollapsed ? 'justify-center w-full' : 'justify-start'].join(' ')}>
            <div className="w-8 h-8 bg-primary-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-[0_10px_25px_rgba(22,163,74,0.35)]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="app-topbar h-16 flex items-center justify-between px-4 sm:px-6 flex-shrink-0">
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="lg:hidden text-surface-500 hover:text-surface-700 p-2 rounded-full hover:bg-white/10 transition-colors"
