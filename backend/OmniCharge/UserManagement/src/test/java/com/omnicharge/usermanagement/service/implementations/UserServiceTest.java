...
class UserServiceTest {
    ...
    void addUser_ShouldReturnUserResponseDTO_WhenEmailDoesNotExist() {
        ...
        when(userRepository.existsByContactNo("9876543210")).thenReturn(false);
    ...
    void addUser_ShouldThrowException_WhenEmailAlreadyExists() {
        ...
        UserAlreadyExistsException ex = assertThrows(UserAlreadyExistsException.class, () -> userService.addUser(userRequestDTO));
        assertEquals("Email is already registered", ex.getMessage());
        verify(userRepository, never()).save(any());
    }

    @Test
    @DisplayName("addUser: should throw UserAlreadyExistsException when phone already exists")
    void addUser_ShouldThrowException_WhenPhoneAlreadyExists() {
        when(userRepository.existsByEmail("rahul@example.com")).thenReturn(false);
        when(userRepository.existsByContactNo("9876543210")).thenReturn(true);
