...
public class RabbitMQConfig {
    ...
    public static final String SAGA_ROUTING_CANCELLED = "payment.cancelled";
    ...
    @Bean
    public Binding paymentSagaCancelledBinding(Queue paymentSagaQueue,
                                               DirectExchange sagaExchange) {
        return BindingBuilder.bind(paymentSagaQueue)
                .to(sagaExchange).with(SAGA_ROUTING_CANCELLED);
    }
