...
class NotificationConsumerTest {
    ...
    // ✅ Happy path
    @Test
    @DisplayName("consume: should send email when contact data is present")
    void consume_ShouldSendEmail_WhenContactDataIsPresent() {
    ...
    // ✅ Email fails → consumer should not crash
    @Test
    void consume_ShouldNotThrow_WhenEmailFails() {
    ...
    // ✅ Phone is present but ignored → no crash
    @Test
    void consume_ShouldNotThrow_WhenPhoneNumberIsPresent() {
