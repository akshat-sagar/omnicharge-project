...
class OperatorControllerTest {
    ...
    void createOperator_Returns200() throws Exception {
        ...
        OperatorResponseDTO res = new OperatorResponseDTO("Airtel");
    ...
    void getOperator_Returns200() throws Exception {
        when(operatorService.getOper(1L)).thenReturn(new OperatorResponseDTO("Airtel"));
    ...
    void getAllOperators_Returns200WithList() throws Exception {
        when(operatorService.getOperList()).thenReturn(
                List.of(new OperatorResponseDTO("Airtel"), new OperatorResponseDTO("Jio")));
    ...
    void updateOperator_Returns200() throws Exception {
        ...
        when(operatorService.updateResponse(eq(1L), any())).thenReturn(new OperatorResponseDTO("Jio"));
